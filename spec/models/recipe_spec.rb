...
RSpec.describe Recipe, type: :model do
  context "when creating a recipe" do
    it "validates that the recipe has a unique url" do
      recipe1 = create(:recipe, recipe_url: "https://www.grubdaily.com/amp/tomato-soup")
      recipe2 = build(:recipe, recipe_url: "https://www.grubdaily.com/amp/tomato-soup")

      expect(recipe2).to be_invalid
    end

    let(:recipe2) { create(:recipe, recipe_url: "https://www.grubdaily.com/tomato-soup") }
    ...
    it "deletes another non-amp version of the same recipe if there is one" do
      recipe1 = create(:recipe, recipe_url: "https://www.grubdaily.com/swedish-meatballs")
      recipe2 = create(:recipe, recipe_url: "https://www.grubdaily.com/swedish-meatballs/amp")
